...
class Image {
	...
	public function __construct($imageFilename) {
		...
		// Use only one of the two following lines - one of these should be commented out.
		// The first line shows relative reference for an image on the public side of the application.
		// The second line shows absolute reference for an image on the private side of the application.
//		$this->path = 'content/images/' . $imageFilename;
		$this->path = APP_NON_WEB_BASE_DIR . 'images/'. $imageFilename;
