            ...
            <div class="content_wrapper clearfix">
                <div class="sections_group">
                    <div class="entry-content">
                        <div class="section mcb-section no-margin-h no-margin-v dark equal-height bg-cover" style="padding-top:10px; padding-bottom:700px; background-image:url(content/fitness2/images/fotness2-gallery-topbg.jpg); background-repeat:no-repeat; background-position:center bottom">
