...
class ProductsVM {
    ...
    public static function getAddEditInstance() {
        ...
        $userId = $_SESSION['userId']; // This should come from the session data in the final version.
        $imageFilename = 'profile_picture'; // This should come from the file upload code in the final version.
		$someVariable = upload_file($imageFilename);
